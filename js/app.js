      ...
      content = `
        ...
        <div class="input-group" style="margin-bottom: var(--space-4);">
          ...
          <select class="input" id="themeSelect" onchange="setTheme(this.value)">
            <option value="dark" ${storedKey === 'dark' || !storedKey ? 'selected' : ''}>Dark</option>
            <option value="light" ${storedKey === 'light' ? 'selected' : ''}>Light</option>
            <option value="auto" ${storedKey === 'auto' ? 'selected' : ''}>Auto (System)</option>
          </select>
          <div style="font-size: var(--font-size-xs); color: var(--text-tertiary); margin-top: var(--space-2);">
