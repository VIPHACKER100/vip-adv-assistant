 ...
 * Function Definitions and Execution Handlers
 */
            ...
            functions: [
                {
                    ...
                    description: 'AI-powered object detection, OCR, and scene understanding',
                    badge: 'Popular',
                    badgeType: 'accent'
                },
                {
                    ...
                    icon: '🔍',
                    title: 'Visual Search',
                    description: 'Search by image, find products, or identify locations',
                },
                {
                    id: 'enhance_media',
                    icon: '✨',
                    title: 'Media Enhancement',
                    description: 'AI upscaling, noise reduction, and style transfer',
                },
                {
                    id: 'screen_understanding',
                    icon: '📱',
                    title: 'Screen Understanding',
                    description: 'Understand and interact with on-screen content',
                },
                {
                    id: 'generate_content',
                    icon: '🎨',
                    title: 'Content Generation',
                    description: 'Generate images, text, or media using AI',
                }
            ]
        },
        {
            ...
            functions: [
                {
                    ...
                    description: 'Build custom routines from natural language',
                    badge: 'New',
                    badgeType: 'success'
                },
                {
                    ...
                    description: 'View, edit, or execute saved automations',
                },
                {
            ...
            functions: [
                {
                    ...
                    description: 'Fingerprint, face, or voice authentication',
                },
                {
                    id: 'secure_vault',
                    icon: '🔐',
                ...
                },
                {
                    ...
                    icon: '📍',
                    title: 'Find Device',
                    description: 'Locate, lock, or wipe device remotely',
                }
            ]
        },
        {
            ...
            functions: [
                {
                    ...
                    icon: '💭',
                    title: 'Smart Reply',
                    description: 'AI-generated contextual message suggestions',
                    badge: 'Popular',
                    badgeType: 'accent'
                },
                {
                    ...
                    description: 'AI-assisted message composition',
                },
                {
                    id: 'meeting_assistant',
                    icon: '🎥',
                    title: 'Meeting Assistant',
                    description: 'Join, transcribe, or summarize meetings',
                },
                {
                ...
                },
                {
                    ...
                    description: 'Advanced voice commands and control',
                }
            ]
        },
        {
            ...
            functions: [
                {
                    ...
                    description: 'Manage lights, thermostat, locks, and more',
                },
                {
                    id: 'iot_automation',
                    icon: '🔄',
                    title: 'IoT Automation',
                    description: 'Create smart home automations',
                }
            ]
        },
        {
            ...
            functions: [
                {
                    ...
                    description: 'Detailed app and screen time insights',
                },
                {
                    id: 'wellness_check',
                    icon: '💚',
                    title: 'Wellness Check',
                    description: 'Digital wellbeing and health integration',
                },
                {
                    id: 'performance_optimization',
                    icon: '⚙️',
                    title: 'Performance Optimization',
                    description: 'Battery, storage, and memory optimization',
                }
            ]
        }
    ];
